  ...
  return (
    <section className="w-full gradient-2 mt-[5rem] rounded-tr-[10rem] rounded-bl-[10rem] px-[2rem] xl:px-0">
      <div className="max-w-[1200px] mx-auto py-[6rem] relative flex flex-col items-center">
        ...
        <h1 className="text-[2.2rem] xs:mt-[14.5rem] mt-[12rem] md:mt-[18rem] lg:mt-0 font-[700] text-main-font mb-[1.8rem]">
          Explore Our App!
        </h1>

        <p className="max-w-[420px] text-slate-500 text-center">
